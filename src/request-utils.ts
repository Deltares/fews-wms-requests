...
export function requestAscii (url: string) {
  return new Promise((resolve: any, reject: any) => {
    const xhr = new XMLHttpRequest()
    xhr.open('GET', url)
    xhr.onload = function () {
...
export function filterToParams (filter: Object) {
...
export function filterToParamsWMS (requestType: WMSRequestType, filter: any) {
